...
class DataTransformationConfig:
    def __init__(self):
        ...
        self.TRANSFORMED_TRAIN_DATA_DIR:str = os.path.join(
            os,getcwd(),DATA_TRANSFORMATION_ARTIFACTS_DIR , TRANSFORMED_TRAIN_DATA_DIR
        )
        self.TRANSFORMED_TEST_DATA_DIR:str = os.path.join(
            os,getcwd(),DATA_TRANSFORMATION_ARTIFACTS_DIR , TRANSFORMED_TEST_DATA_DIR
        )
        
        self.TRANSFORMED_TRAIN_DATA_FILE_PATH:str = os.path.join(
            os,getcwd(),TRANSFORMED_TRAIN_DATA_DIR , TRANSFORMED_TRAIN_DATA_FILE_NAME
        )
        self.TRANSFORMED_TEST_DATA_FILE_PATH:str = os.path.join(
            os,getcwd(),TRANSFORMED_TEST_DATA_DIR , TRANSFORMED_TEST_DATA_FILE_NAME
        )
